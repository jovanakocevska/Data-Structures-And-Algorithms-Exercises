...
public class DLLSortiranje4 {

	public static void Sortiranje4(DLL<Integer> lista1, DLL<Integer> lista2) {
...
// Да се напише алгоритам кој ќе ги вметне сите јазли од втората листа во првата листа 
// без да ја наруши нејзината подреденост, 
// притоа вметнување на дупликати не е дозволено.
// 2 4 5 7 9 11 12 15 17 
// 18 1 7 8 9 3 16
