...
public class HashRodendeni2 {

	public static void main(String[] args) throws IOException {
		// TODO Auto-generated method stub
		BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
		String s, ime, prezime, rodenden, imePrezimeGodina, denMesec, denMesecBaraj, godina, godinaBaraj;
		...
		if (h != -1) {
			...
			Collections.sort(al);
			for (i = 0; i < al.size(); i ++) {
				String chovek = al.get(i);
				pom4 = chovek.split(" ");
				imePrezime = pom4[0] + " " + pom4[1];
				godina = pom4[2];
