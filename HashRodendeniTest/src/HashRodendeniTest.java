...
public class HashRodendeniTest {

	public static void main(String[] args) throws IOException {
		// TODO Auto-generated method stub
		BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
		String s, ime, datum, mesec, mesecBaraj, novoIme;
		String []pom, datumPom;
		int n, i, h;
		...
		for (i = 0; i < n; i++) {
			...
			if (h == -1) {
				...
				novoIme = tabela.buckets[h].value;
				if (novoIme.contains(" " + ime + " ")) { 
					continue;
				} else {
					novoIme += ime + " ";
					tabela.insert(mesec, novoIme);
				}
		...
		if (h == -1) {
			...
			System.out.println(tabela.buckets[h].value.trim());
		}
