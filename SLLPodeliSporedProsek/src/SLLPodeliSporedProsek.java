...
public class SLLPodeliSporedProsek {

	public static void podeliSporedProsek(SLL<Integer> lista, SLL<Integer> lista1, SLL<Integer> lista2) {
		...
		while (tmp != null) {
			zbir = zbir + tmp.element;
			tmp = tmp.succ;
		}

		prosek = (float)zbir / lista.length();
	...
	public static void main(String[] args) throws IOException {
		...
		podeliSporedProsek(lista, lista1, lista2);
