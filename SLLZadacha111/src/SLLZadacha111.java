...
public class SLLZadacha111 {
	...
	public static void Zadacha111_2(SLL<Integer> lista) {

		SLLNode<Integer> prv = lista.getFirst();
		SLLNode<Integer> posleden = lista.getFirst();

		// vaka ne se preporacuva
		while (posleden.succ != null) {
			posleden = posleden.succ;
		}
		...
		posleden.element = tmp;
	}

	public static void Zadacha111_3(SLL<Integer> lista) {

		SLLNode<Integer> prv = lista.getFirst();
		SLLNode<Integer> pretposleden = lista.getFirst();
		SLLNode<Integer> posleden = lista.getFirst();
		...
		posleden = pretposleden.succ;
		posleden.succ = prv.succ;
		pretposleden.succ = prv;
		prv.succ = null;

		lista.first = posleden;
	}
