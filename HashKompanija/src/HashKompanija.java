...
public class HashKompanija {

	public static void main(String[] args) throws IOException {
		// TODO Auto-generated method stub
		BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
		String s, vraboten, menadzer, starMenadzer;
		String[] pom;
		...
		for (i = 0; i < n; i++) {
			...
			if (h1 == -1) {
				...
				starMenadzer = tabelaVM.buckets[h1].value;
				tabelaVM.insert(vraboten, menadzer);
				if (!vraboten.equals(starMenadzer)) {
					h2 = tabelaM.search(starMenadzer);
					if (h2 != -1) {
						brojac = tabelaM.buckets[h2].value;
						brojac--;
						tabelaM.insert(starMenadzer, brojac);
					}
				}
			}
