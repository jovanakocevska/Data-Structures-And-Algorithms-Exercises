...
public class DLLNaizmenicnoDodavanjeElementi {

	public static void naizmenicnoDodavanjeElementi(DLL<Integer> lista1, DLL<Integer> lista2, DLL<Integer> rezultat) {
	...
	public static void main(String[] args) throws IOException {
		...
		naizmenicnoDodavanjeElementi(lista1, lista2, rezultat);
