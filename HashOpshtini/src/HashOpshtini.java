...
public class HashOpshtini {
	...
	public static void main(String[] args) throws IOException {
		...
		int n, i, h;
		String s, imeOpstina;
		float zagaduvanje, vkzagaduvanje = 0;
		String[] pom;

		s = br.readLine();
		n = Integer.parseInt(s);

		OBHT<String, ArrayList<Float>> tabela = new OBHT<String, ArrayList<Float>>(2 * n + 1);
		ArrayList<Float> al = null;
		...
		if (h == -1) {
			...
			vkzagaduvanje = 0;
			for (i = 0; i < al.size(); i++) {
				vkzagaduvanje += al.get(i);
			}
			zagaduvanje = vkzagaduvanje / al.size();
		
			// System.out.println(zagaduvanje); // - 3.1899998
			
			System.out.printf("%.2f", zagaduvanje);
			System.out.println("");
